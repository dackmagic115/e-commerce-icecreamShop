...
<body class="homepage">   
  ...
  <div class="wrapper">
         ...
         <header id="header">
        <nav class="navbar navbar-fixed-top" role="banner" style="background: #ff33ff; filter: opacity(90%);box-shadow: 1px 2px 2px 1px rgba(0, 0, 0, 0.07) ">
      ...
      <section id="feature" style="background: #ff33ff;" >
                  <div style=" padding-left: 50px;  margin-top: 150px;  ">
                       <div class="left " style="background: #ff33ff;">
      ...
      <section id="features" style="background:#ff33ff;">
        <div style="padding-left: 10%; padding-right: 10%;">
         <div class="center wow fadeInDown"  style="padding-right: 20px; margin-top: 0px;">
                <h1 style="color: #fff; text-shadow: 4px 4px 2px 0px black;"><img src="image/logobowl.png" width="70" height="70">ไอศครีมถ้วย</h1>
                </p>
                 <p class="lead" align="right" style="font-size: 20px;"><a href="cart.php"><i class="fa fa-shopping-cart fa-5x"></i><br>ตะกร้าสินค้า</a></p>
            </div>

            <div class="row">
                <div class="features" style="background: #ff33ff; " align="center">
                  <?php
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms" >
                        <div class="hvr-grow">
                          <a href="menu_details2.php?id_product=<?php echo $row["idProducts"];?>">
      ...
      <footer id="footer" class="midnight-blue" style="background: #ff33ff;">
