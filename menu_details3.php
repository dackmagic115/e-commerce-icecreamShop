...
<body>
<div style="background: #228b22; width: 100% ; height: 955px;">
	...
	<div class="row">
		...
		<div class="col-md-1" align="center" style="padding-top: 30px;">
   			 <a href="menu3.php"><i class="fa fa-times fa-3x"></i></a>
   		</div>		 
	</div>
	<div class="row">
		<div class="col-md-12" style="height: 40% ; padding-top: 50px;" align="center">
			<div>
			<img src="upload/<?php echo $row["P_image"];?>" width="250" height="300" ><br><br>
			</div>
			
		</div>
	</div>
	<div class="row">
		<div class="col-md-9" style="background: #228b22; ; height: 300px;">
